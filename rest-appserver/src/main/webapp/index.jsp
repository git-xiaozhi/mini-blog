  ...
  <div id="content">
    ...
    <authz:authorize ifNotGranted="ROLE_USER">
      ...
      <form id="loginForm" name="loginForm" action="<c:url value="/login.do"/>" method="post">
        <p><label>Username: <input type='text' name='j_username' value="change"></label></p>
        <p><label>Password: <input type='text' name='j_password' value="111111111"></label></p>
        <p><label>Remember Me :<input id="_spring_security_remember_me" name="_spring_security_remember_me" type="checkbox" checked /></label></p>
