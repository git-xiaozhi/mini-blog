...
ECOTree = function (obj, elm) {
	this.config = {
		...
		expandedImage : '/static/images/less.gif',
		collapsedImage : '/static/images/plus.gif',
		transImage : '/static/images/trans.gif'
	}
...
ECOTree.prototype.toString = function () {	
	...
	{
		case "CANVAS":
			s.push('<canvas id="ECOTreecanvas" width=930 height=1500></canvas>');
			break;
