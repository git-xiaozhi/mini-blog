...
public class SinaFollowersController {
    ...
    public String followers(@RequestParam(required = false,defaultValue="1") Integer page,Model model) {
    ...
    public String followings(@RequestParam(required = false,defaultValue="1") Integer page,Model model) {
		SinaAccessToken accessToken = (SinaAccessToken)retwis.getAccessTokenByUser(LoginHelper.getUserId());
		friendships.client.setToken(accessToken.getAccesstoken());
		try {
